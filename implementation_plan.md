...
#### [MODIFY] [globals.css](file:///c:/Users/Girish%20Lade/OneDrive/Desktop/freelancer-portfolio/girish-portfolio/app/globals.css)
- Define CSS keyframe animations for a seamless marquee loop (`marquee` and `marquee2`).
- Define utility classes for marquee scroll tracks (`.animate-marquee` and `.animate-marquee2`).
